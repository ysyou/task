...
<div class="card card-default card-profile">
  ...
  <div class="card-body card-profile-body">
    ...
    <div class="profile-avata">
      <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-md-01.jpg" alt="Avata Image">
    ...
    <div class="profile-button">
      <a class="btn btn-primary btn-pill" href="user-planing-settings.jsp">Upgrade Plan</a>
    </div>
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="user-profile-settings.jsp">Settings</a>
      </li>
      ...
      <div class="card-body">
        ...
        <div class="media media-sm border-bottom pb-6">
          ...
          <div class="media-body">
            <div class="d-flex justify-content-between flex-wrap align-items-center mb-5">
              <div class="left-side">
                <a class="title mb-0 d-block" href="user-profile.jsp">Selena Wagner</a>
                <a class="d-block" href="user-profile.jsp">Designer</a>
              </div>
            ...
            <div class="row user-gallery">
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-01.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-02.jpg" alt="Gallery Image">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="media media-sm border-bottom">
          ...
          <div class="media-body">
            <div class="d-flex justify-content-between flex-wrap align-items-center mb-5">
              <div class="left-side">
                <a class="title mb-0 d-block" href="user-profile.jsp">Walter Reuter</a>
                <a class="d-block" href="user-profile.jsp">Designer</a>
              </div>
              <div class="right-side">
        ...
        <div class="media media-sm border-bottom pb-6">
          ...
          <div class="media-body">
            <div class="d-flex justify-content-between flex-wrap align-items-center mb-5">
              <div class="left-side">
                <a class="title mb-0 d-block" href="user-profile.jsp">Larissa Gebhard</a>
                <a class="d-block" href="user-profile.jsp">Cyber Punk</a>
              </div>
              <div class="right-side">
            ...
            <div class="row user-gallery">
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-03.jpg" alt="Gallery Image">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="media media-sm border-bottom pb-6">
          ...
          <div class="media-body">
            <div class="d-flex justify-content-between flex-wrap align-items-center mb-5">
              <div class="left-side">
                <a class="title mb-0 d-block" href="user-profile.jsp">Albrecht Straub</a>
                <a class="d-block" href="user-profile.jsp">Photographer</a>
              </div>
              <div class="right-side">
            ...
            <div class="row user-gallery">
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-04.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-05.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-06.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-07.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-08.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-09.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-10.jpg" alt="Gallery Image">
              </div>
              <div class="col-md-6 col-lg-4 col-xl-3">
                <img class="img-fluid mb-6" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/gallery/gallery-img-11.jpg" alt="Gallery Image">
              </div>
            </div>
          </div>
        </div>
