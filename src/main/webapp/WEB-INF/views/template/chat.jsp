...
<html lang="en" dir="ltr">
  ...
  <link href="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
  ...
  <link href="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/toaster/toastr.min.css" rel="stylesheet" />
    ...
    <div class="card card-default chat-left-sidebar">
      ...
      <ul class="card-body px-0" data-simplebar style="height: 630px;">
        <li class="mb-4 px-5 py-2">
          <a href="javascript:void(0)" class="media media-message">
            <div class="position-relative mr-3">
              <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-sm-01.jpg" alt="User Image">
        ...
        <li class="mb-4 px-5 py-2">
          <a href="javascript:void(0)" class="media media-message">
            <div class="position-relative mr-3">
              <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-sm-02.jpg" alt="User Image">
              <span class="status away"></span>
            </div>
        ...
        <li class="bg-primary mb-4 px-5 py-2">
          <a href="javascript:void(0)" class="media media-message">
            <div class="position-relative mr-3">
              <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-sm-03.jpg" alt="User Image">
        ...
        <li class="mb-4 px-5 py-2">
          <a href="javascript:void(0)" class="media media-message">
            <div class="position-relative mr-3">
              <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-sm-04.jpg" alt="User Image">
              <span class="status away"></span>
            </div>
        ...
        <li class="mb-4 px-5 py-2">
          <a href="javascript:void(0)" class="media media-message">
            <div class="position-relative mr-3">
              <img class="rounded-circle" src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/images/user/user-sm-05.jpg" alt="User Image">
              <span class="status away"></span>
            </div>
        ...
        <div class="dropdown">
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
              <a class="dropdown-item" href="user-profile-settings.jsp">Profile</a>
          ...
          <footer class="footer mt-auto">
            ...
            <script>
                ...
                document.getElementById("copy-year").innerHTML = year;
                    ...
                    <script src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
                    <script src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/jvectormap/jquery-jvectormap-world-mill.js"></script>
                    <script src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/jvectormap/jquery-jvectormap-us-aea.js"></script>
                    ...
                    <script src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/toaster/toastr.min.js"></script>
