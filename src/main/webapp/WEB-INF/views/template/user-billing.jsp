...
<html lang="en" dir="ltr">
  ...
  <link href="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/select2/css/select2.min.css" rel="stylesheet" />
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">user billing</span>
...
<div class="card card-default card-profile">
  ...
  <div class="card-footer card-profile-footer">
    <ul class="nav nav-border-top justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="user-activities.jsp">Activities</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="user-profile-settings.jsp">Settings</a>
      </li>
    ...
    <div class="card card-default">
      ...
      <div class="card-body pt-0">
         <ul class="nav nav-settings">
          <li class="nav-item">
            <a class="nav-link" href="user-profile-settings.jsp">
              <i class="mdi mdi-account-outline mr-1"></i> Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="user-account-settings.jsp">
              <i class="mdi mdi-settings-outline mr-1"></i> Account
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="user-planing-settings.jsp">
              <i class="mdi mdi-currency-usd mr-1"></i> Planing
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="user-billing.html">
              <i class="mdi mdi-set-top-box mr-1"></i> Billing
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="user-notify-settings.jsp">
          ...
          <footer class="footer mt-auto">
            ...
            <script>
                ...
                document.getElementById("copy-year").innerHTML = year;
                    ...
                    <script src="../../../../../../../../Users/clamos/Downloads/mono-main/theme/plugins/select2/js/select2.min.js"></script>
