                  ...
                  <div class="col-lg-12">
                    <div class="card card-default text-dark">
                      ...
                      <div class="card-body pt-4">
                        ...
                        <p>To start from scratch using our template, first download <em>Mono Dashboard</em> from <a href="https://github.com/tafcoder/mono-dashboard/releases">latest release</a>. Be sure to have your pages set up with the latest design and development standards. That means using an HTML5 doctype
...
&lt;/html&gt;
                        ...
                        <p>If you want to use <em>Mono Dashboard</em> from npm package run following command in your terminal.</p>
<pre class="mt-4">
<code>npm i mono-dashboard --save</code>
</pre>
                        <h2 class="mt-5 mb-2">Existing Project</h2>
                        <p>Looking to quickly add <em>Mono Dashboard</em> to your existing project? Use following CDN links.</p>

                        <h3 class="mt-4 mb-2">CSS</h3>
                        <p>Copy-paste the stylesheet <code>link</code> just before closing <code>head</code> tag.</p>
<pre class="mt-4">
<code>&lt;link href="https://unpkg.com/mono-dashboard/dist/assets/css/mono.min.css" rel="stylesheet"&gt;</code>
</pre>
...
<code>&lt;script src="https://unpkg.com/mono-dashboard/dist/assets/js/mono.bundle.js"&gt;&lt;/script&gt;</code>
</pre>
