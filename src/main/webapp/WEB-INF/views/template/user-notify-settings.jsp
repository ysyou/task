      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">user notifications settings</span>
...
<div class="row">
    ...
    <div class="card card-default">
      ...
      <div class="card-body pt-0">
        <ul class="nav nav-settings">
          ...
          <li class="nav-item">
            <a class="nav-link" href="user-billing.jsp">
              <i class="mdi mdi-set-top-box mr-1"></i> Billing
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="user-notify-settings.html">
  ...
  <div class="col-xl-9">
    ...
    <div class="card card-default">
      <div class="card-header">
        <h2 class="mb-5">Notifications Settings</h2>

      </div>

      <div class="card-body">
        <ul class="list-underline">
          <li class="list-item">Someone follows you
